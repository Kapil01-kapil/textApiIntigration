    ...
    if (this.props.is_success_add !== prevProps.is_success_add) {
      ...
      if (this.props.is_success_add == true) {
        ...
        if (
          ...
          delivery_Fees =
            parseFloat(this.props.route.params.fuelTypePrice) +
            parseFloat(this.props.user_data_membership_list.delivery_fee);
          ...
          delivery_Fees =
            parseFloat(this.props.route.params.fuelTypePrice) +
            parseFloat(this.props.user_data_membership_list.delivery_fee) +
            parseFloat(this.props.user_data_membership_list_data.price);
        }
                  ...
                  this.state.Delivery_fee ? (
                    <View style={{ flexDirection: "row" }}>
                      <View>
                        ...
                        >
                          ${this.state.orderData.deliveryFee}
                        </Text>
                      </View>
                      <Text
                        style={{
