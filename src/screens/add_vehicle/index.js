...
const initalBoatData = {
  make: [{ title: "Audi" }, { title: "BMW" }],
  color: [{ title: "RED" }, { title: "BLACK" }, { title: "BLUE" }],
  model: [{ title: "A4" }, { title: "A6" }, { title: "A8" }],
  fuel_type: [{ title: "REC 90" }, { title: "Diesel" }],
};
import {
  FreshChat_APP_ID,
  FreshChat_APP_KEY,
...
class AddVehicle extends Component {
  ...
  setFlatlistData = (dropdownData) => {
    ...
    if (this.state.is_boat_seleted == true) {
      this.props &&
        this.props.fuelTypeList_data &&
        this.props.fuelTypeList_data.boats.map((item) => {
          var data = {
            value: item._id,
            label: item.fuelType,
          };
      ...
      this.props &&
        this.props.fuelTypeList_data &&
        this.props.fuelTypeList_data.cars.map((item) => {
          var data = {
            value: item._id,
            label: item.fuelType,
          };
  ...
  componentDidUpdate(prevProps) {
    ...
    if (
      ...
      console.log(
        "kapilis_success_fuelTypeList => " + this.props.fuelTypeList_data
      );
      console.log(
          ...
          <TxtFullScreenBtn
            ...
            onPress={() => {
              const request = {
                ...
                tags: this.props && this.props.user_data && this.state.tagValue,
                user_token:
                  this.props &&
                  this.props.user_data &&
              ...
              //  console.log("adding vehicle updated...", JSON.stringify(this.props.user_data.data.user_token));
