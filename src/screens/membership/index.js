...
class Membership extends Component {
  ...
  callAPI() {
    this.props.membership({
      user_id: this.props.user_data.data._id,
      cardToken: this.props.route.params.requestData.card_id,
    ...
    return (
      ...
      >
        ...
        <View style={styles.container}>
          ...
          >
            for only ${this.props.user_data_membership_list_data.price} a month
          </Text>
            ...
            <TxtFullScreenBtn
              ...
              onPress={() => {
                this.props.navigation.navigate("Payment", {
                  ...
                  orderData: "",
                  is_selected_home: "",
                  price: this.props.user_data_membership_list_data.price,
                });
              }}
